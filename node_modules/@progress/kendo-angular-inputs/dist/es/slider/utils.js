...
export function decreaseValueToStep(value, _a) {
    ...
    var stepValue = value - min;
    var result;
    if (stepValue % smallStep === 0) {
        result = stepValue - smallStep;
    }
    else {
        result = stepValue - (stepValue % smallStep);
    }
    return limitValue(result + min, min, max);
}
/**
 * @hidden
 */
export function increaseValueToStep(value, _a) {
    var max = _a.max, min = _a.min, smallStep = _a.smallStep;
    var stepValue = value - min;
    var result = stepValue - (stepValue % smallStep) + smallStep;
    return limitValue(result + min, min, max);
}
/**
 * @hidden
