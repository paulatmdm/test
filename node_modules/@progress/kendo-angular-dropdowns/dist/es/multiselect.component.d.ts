...
import { ElementRef, TemplateRef, OnDestroy, OnChanges, EventEmitter, AfterContentChecked, AfterViewInit, ChangeDetectorRef } from '@angular/core';
...
export declare class MultiSelectComponent implements OnDestroy, OnChanges, AfterContentChecked, AfterViewInit {
    ...
    constructor(rtl: boolean, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, cdr: ChangeDetectorRef);
