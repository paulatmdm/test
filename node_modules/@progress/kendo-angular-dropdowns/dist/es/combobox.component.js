...
import { Component, forwardRef, ElementRef, Input, Output, EventEmitter, ContentChild, ViewChild, HostBinding, isDevMode, Optional, Inject, ChangeDetectorRef } from '@angular/core';
...
var ComboBoxComponent = (function () {
    ...
    ComboBoxComponent.prototype.emitChange = function () {
        ...
        this.selectionSubject.next(this.data.findIndex(function (element) {
            return getter(element, _this.valueField) === _this.value;
        }));
